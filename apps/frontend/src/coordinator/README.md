...
See the detailed API contract in [api_contract_dashboard_agent_mvp_detailed.md](/d:/swin/swin2026/goalpilot/docs/api-contract/api_contract_dashboard_agent_mvp_detailed.md).
